        ...
        <div class="modal-content">
            <form action="borrar.php" method="POST"> <!-- Formulario que envía los datos a borrar.php -->
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="modalOpinionInput" name="opinion">
